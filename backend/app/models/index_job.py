...
class IndexJob(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_index_jobs_token_limits",
        ),
        CheckConstraint("max_chunks > 0", name="ck_index_jobs_max_chunks_positive"),
        CheckConstraint(
            "embed_batch_size > 0", name="ck_index_jobs_embed_batch_positive"
        ),
        UniqueConstraint(
